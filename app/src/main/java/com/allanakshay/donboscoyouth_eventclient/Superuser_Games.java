...
public class Superuser_Games extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_superuser__games);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        games_list = (ListView) findViewById(R.id.superuser_games_listview);
        adapter = new Superuser_Adapter(item_list, price_list, this, "Games");
        ...
        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.superuser_games_fab);
        ...
        set_price.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!(price.getText().toString().trim().equals("") || item.getText().toString().trim().equals("")))
                {
                    ...
                    query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            if(dataSnapshot.getValue() == null)
                            {
                                ...
                                ref_users.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        for(DataSnapshot snapshot : dataSnapshot.getChildren())
                                            ref_users.child(snapshot.getKey()).child("Games Played").child(item.getText().toString().trim()).setValue("0");
                                ...
                                Toast.makeText(Superuser_Games.this, "Item successfully added", Toast.LENGTH_SHORT).show();
                                ((ViewGroup)view.getParent()).removeView(view);
                            }
                            else
                                Toast.makeText(Superuser_Games.this, "Item already exists", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Superuser_Games.this, "Please Enter all the fields", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        ref_games.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    Toast.makeText(Superuser_Games.this, "Error in fetching games list", Toast.LENGTH_SHORT).show();
                }
            }
